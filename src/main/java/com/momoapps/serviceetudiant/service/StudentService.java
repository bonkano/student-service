package com.momoapps.serviceetudiant.service;

import com.momoapps.serviceetudiant.model.Course;
import com.momoapps.serviceetudiant.model.Student;
...
public class StudentService {
    ...
    static {
        ...
        Student ranga = new Student("Student1", "Ranga Karanam", "Hiker, Programmer and Architec",
                new ArrayList<>(Arrays.asList(course1, course2, course3, course4)));
        Student satish = new Student("Student2", "Satish T", "Hiker, Programmer and Architec",
                new ArrayList<>(Arrays.asList(course1, course2, course3, course4)));
